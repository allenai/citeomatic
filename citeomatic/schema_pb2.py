...
_DOCUMENT = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name='in_citation_count',
            full_name='Document.in_citation_count',
            index=6,
            number=8,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='out_citation_count',
            full_name='Document.out_citation_count',
            index=7,
            number=9,
            type=5,
            cpp_type=1,
...
Hit = _reflection.GeneratedProtocolMessageType(
    'Hit',
    (_message.Message,),
    dict(
        DESCRIPTOR=_HIT,
...
PostingList = _reflection.GeneratedProtocolMessageType(
    'PostingList',
    (_message.Message,),
    dict(
